...
class AdminActionController(
    ...
    fun executeAction(
        ...
        val (title, message, success) = when (result) {
        ...
        val html = buildHtml(title, message, success)
        return ResponseEntity.ok(html)
    }

    private fun buildHtml(title: String, message: String, success: Boolean): String {
        ...
        <head>
          ...
          <style>
            ...
            .card { background: white; border-radius: 12px; padding: 40px; text-align: center; box-shadow: 0 2px 12px rgba(0,0,0,.1); max-width: 360px; width: 90%; }
