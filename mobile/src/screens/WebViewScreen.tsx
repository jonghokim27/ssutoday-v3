  ...
  return (
    <View style={styles.container}>
      <WebView
        ...
        injectedJavaScriptBeforeContentLoaded="(function(){var m=document.querySelector('meta[name=viewport]');if(!m){m=document.createElement('meta');m.name='viewport';document.head.appendChild(m);}m.content='width=device-width,initial-scale=1,maximum-scale=1,minimum-scale=1';})();true;"
      />
      {smartId && (
        <View
