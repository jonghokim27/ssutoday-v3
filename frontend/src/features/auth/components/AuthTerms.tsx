...
const termsGroups = [
  {
    title: '이용약관',
    meta: ['공개일: 2023년 08월 28일', '수정일: 2026년 07월 01일'],
    sections: [
      {
        title: '제1조 (목적)',
        body: [
      ...
      },
      {
        ...
        body: [
          '다음 각 호의 사유가 발생한 경우, 회사는 해당 이용자의 서비스 이용을 제한할 수 있습니다.',
          '- 이용자가 본 약관을 위반한 경우',
          '- 이용자가 부정한 방법으로 서비스를 이용한 경우',
          '- 이용자가 서비스의 정상적인 운영을 방해하는 경우',
          '- 기타 회사가 서비스 제공을 위해 필요하다고 판단한 경우',
          '- 대한민국 법령에 따라 서비스 제공이 제한되는 경우',
          '서비스 이용의 제한은 회사의 재량에 따라 결정되며, 이용자에게 사전 통지 없이 이루어질 수 있습니다.',
          '',
